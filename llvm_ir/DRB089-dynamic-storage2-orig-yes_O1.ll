; ModuleID = 'dataracebench/DRB089-dynamic-storage2-orig-yes.c'
source_filename = "dataracebench/DRB089-dynamic-storage2-orig-yes.c"
...
define dso_local i32 @main() local_unnamed_addr #0 {
  %1 = call noalias align 16 dereferenceable_or_null(4) i8* @malloc(i64 4) #4
...
3:                                                ; preds = %0
  ...
  %5 = call i64 @fwrite(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i64 15, i64 1, %struct._IO_FILE* %4) #8
...
define internal void @.omp_outlined.(i32* noalias nocapture readnone %0, i32* noalias nocapture readnone %1) #3 {
...
attributes #3 = { alwaysinline mustprogress nofree norecurse nosync nounwind uwtable willreturn "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
