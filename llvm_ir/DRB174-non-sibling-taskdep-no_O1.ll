; ModuleID = 'dataracebench/DRB174-non-sibling-taskdep-no.c'
source_filename = "dataracebench/DRB174-non-sibling-taskdep-no.c"
...
define internal i32 @.omp_task_entry..3(i32 %0, %struct.kmp_task_t_with_privates.1* noalias nocapture readonly %1) #6 {
  ...
  %17 = call i32 @__kmpc_omp_taskwait(%struct.ident_t* nonnull @1, i32 %0) #5, !noalias !24
...
define internal i32 @.omp_task_entry..7(i32 %0, %struct.kmp_task_t_with_privates.5* noalias nocapture readonly %1) #6 {
  ...
  %17 = call i32 @__kmpc_omp_taskwait(%struct.ident_t* nonnull @1, i32 %0) #5, !noalias !30
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %6)
  ret i32 0
}
