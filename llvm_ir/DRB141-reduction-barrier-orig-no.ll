...
23:                                               ; preds = %22, %3
  call void @__kmpc_barrier(%struct.ident_t* @2, i32 %19)
  store i32 0, i32* %10, align 4
  store i32 9, i32* %11, align 4
  store i32 1, i32* %12, align 4
  store i32 0, i32* %13, align 4
  store i32 0, i32* %14, align 4
  call void @__kmpc_for_static_init_4(%struct.ident_t* @3, i32 %19, i32 34, i32* %13, i32* %10, i32* %11, i32* %12, i32 1, i32 1)
...
48:                                               ; preds = %47
  call void @__kmpc_for_static_fini(%struct.ident_t* @3, i32 %19)
  ...
  %52 = call i32 @__kmpc_reduce(%struct.ident_t* @4, i32 %19, i32 1, i64 8, i8* %51, void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
53:                                               ; preds = %48
  ...
  call void @__kmpc_end_reduce(%struct.ident_t* @4, i32 %19, [8 x i32]* @.gomp_critical_user_.reduction.var)
  br label %60
...
66:                                               ; preds = %63, %60
  call void @__kmpc_barrier(%struct.ident_t* @6, i32 %19)
  ret void
}
