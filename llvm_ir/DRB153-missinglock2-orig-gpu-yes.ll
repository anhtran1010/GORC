...
define dso_local i32 @main() #0 {
  ...
  call void @__omp_offloading_10302_803e92_main_l24(i32* %2) #2
...
define internal void @__omp_offloading_10302_803e92_main_l24(i32* nonnull align 4 dereferenceable(4) %0) #1 {
  %2 = alloca i32*, align 8
  %3 = call i32 @__kmpc_global_thread_num(%struct.ident_t* @3)
  store i32* %0, i32** %2, align 8
  %4 = load i32*, i32** %2, align 8
  call void @__kmpc_push_num_teams(%struct.ident_t* @3, i32 %3, i32 1, i32 0)
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_teams(%struct.ident_t* @3, i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* %4)
  ret void
}
