; ModuleID = 'dataracebench/DRB141-reduction-barrier-orig-no.c'
source_filename = "dataracebench/DRB141-reduction-barrier-orig-no.c"
...
@5 = private unnamed_addr constant %struct.ident_t { i32 0, i32 66, i32 0, i32 0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @0, i32 0, i32 0) }, align 8
@.str = private unnamed_addr constant [11 x i8] c"Sum is %d\0A\00", align 1
@6 = private unnamed_addr constant %struct.ident_t { i32 0, i32 322, i32 0, i32 0, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @0, i32 0, i32 0) }, align 8
...
14:                                               ; preds = %13, %3
  call void @__kmpc_barrier(%struct.ident_t* nonnull @2, i32 %10)
  ...
  call void @__kmpc_for_static_init_4(%struct.ident_t* nonnull @3, i32 %10, i32 34, i32* nonnull %7, i32* nonnull %4, i32* nonnull %5, i32* nonnull %6, i32 1, i32 1)
...
40:                                               ; preds = %26, %14
  ...
  call void @__kmpc_for_static_fini(%struct.ident_t* nonnull @3, i32 %10)
  %42 = bitcast [1 x i8*]* %9 to i32**
  store i32* %8, i32** %42, align 8
  %43 = bitcast [1 x i8*]* %9 to i8*
  %44 = call i32 @__kmpc_reduce(%struct.ident_t* nonnull @4, i32 %10, i32 1, i64 8, i8* nonnull %43, void (i8*, i8*)* nonnull @.omp.reduction.reduction_func, [8 x i32]* nonnull @.gomp_critical_user_.reduction.var)
...
52:                                               ; preds = %45, %49
  call void @__kmpc_end_reduce(%struct.ident_t* nonnull @4, i32 %10, [8 x i32]* nonnull @.gomp_critical_user_.reduction.var)
  br label %53
...
59:                                               ; preds = %56, %53
  call void @__kmpc_barrier(%struct.ident_t* nonnull @6, i32 %10)
  ret void
}
...
; Function Attrs: convergent nounwind
declare i32 @__kmpc_reduce(%struct.ident_t*, i32, i32, i64, i8*, void (i8*, i8*)*, [8 x i32]*) local_unnamed_addr #4

; Function Attrs: convergent nounwind
declare void @__kmpc_end_reduce(%struct.ident_t*, i32, [8 x i32]*) local_unnamed_addr #4
