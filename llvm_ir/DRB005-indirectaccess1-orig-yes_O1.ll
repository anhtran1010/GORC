; ModuleID = 'dataracebench/DRB005-indirectaccess1-orig-yes.c'
source_filename = "dataracebench/DRB005-indirectaccess1-orig-yes.c"
...
define internal void @.omp_outlined.(i32* noalias nocapture readonly %0, i32* noalias nocapture readnone %1, double** nocapture nonnull readonly align 8 dereferenceable(8) %2, double** nocapture nonnull readonly align 8 dereferenceable(8) %3) #4 {
  ...
  call void @__kmpc_for_static_init_4(%struct.ident_t* nonnull @1, i32 %13, i32 33, i32* nonnull %8, i32* nonnull %5, i32* nonnull %6, i32* nonnull %7, i32 1, i32 1)
  %14 = load i32, i32* %7, align 4
  %15 = load i32, i32* %6, align 4, !tbaa !13
  %16 = icmp slt i32 %15, 179
  %17 = select i1 %16, i32 %15, i32 179
...
23:                                               ; preds = %20, %49
  %24 = phi i64 [ %21, %20 ], [ %55, %49 ]
  %25 = phi i32 [ %18, %20 ], [ %50, %49 ]
  %26 = phi i32 [ %17, %20 ], [ %53, %49 ]
...
32:                                               ; preds = %30, %32
  %33 = phi i64 [ %24, %30 ], [ %47, %32 ]
  %34 = getelementptr inbounds [180 x i32], [180 x i32]* @indexSet, i64 0, i64 %33
  ...
  %43 = fadd double %37, 3.000000e+00
  %44 = getelementptr inbounds double, double* %28, i64 %39
  %45 = load double, double* %44, align 8, !tbaa !8
  %46 = fadd double %43, %45
  store double %46, double* %44, align 8, !tbaa !8
  %47 = add i64 %33, 1
  %48 = icmp slt i64 %33, %31
  br i1 %48, label %32, label %49

49:                                               ; preds = %32, %23
  %50 = add nsw i32 %14, %25
  %51 = add nsw i32 %14, %26
  %52 = icmp slt i32 %51, 179
  %53 = select i1 %52, i32 %51, i32 179
  %54 = icmp sgt i32 %50, %53
  %55 = add i64 %24, %22
  br i1 %54, label %56, label %23
