; ModuleID = 'dataracebench/DRB128-tasking-threadprivate2-orig-no.c'
source_filename = "dataracebench/DRB128-tasking-threadprivate2-orig-no.c"
...
; Function Attrs: nounwind uwtable
define weak_odr hidden i32* @_ZTW2tp() local_unnamed_addr #4 comdat {
  ret i32* @tp
}
...
attributes #4 = { nounwind uwtable "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
