...
13:                                               ; preds = %7
  ...
  %14 = getelementptr inbounds [100 x i32], [100 x i32]* %4, i64 0, i64 50
  %15 = load i32, i32* %14, align 8, !tbaa !4
  %16 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 %15)
...
define internal void @.omp_outlined.(i32* noalias nocapture readonly %0, i32* noalias nocapture readnone %1, i32* nocapture nonnull readonly align 4 dereferenceable(4) %2, [100 x i32]* nocapture nonnull align 4 dereferenceable(400) %3) #2 {
