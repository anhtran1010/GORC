; ModuleID = 'dataracebench/DRB051-getthreadnum-orig-no.c'
source_filename = "dataracebench/DRB051-getthreadnum-orig-no.c"
...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 %3)
...
6:                                                ; preds = %3
  %7 = call i32 @omp_get_num_threads()
  store i32 %7, i32* %2, align 4, !tbaa !4
  br label %8
...
; Function Attrs: nounwind
declare dso_local i32 @omp_get_num_threads() local_unnamed_addr #3
