...
7:                                                ; preds = %3
  ...
  store i32 %8, i32* %2, align 4, !tbaa !4
  %9 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 %8)
...
; Function Attrs: nounwind
declare dso_local i32 @omp_get_num_threads() local_unnamed_addr #4
