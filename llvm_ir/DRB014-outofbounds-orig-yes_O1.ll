...
define dso_local i32 @main(i32 %0, i8** nocapture readnone %1) local_unnamed_addr #0 {
  ...
  %9 = getelementptr inbounds [10000 x double], [10000 x double]* %8, i64 0, i64 0
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull @2, i32 5, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, i32*, i64, i64, double*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* nonnull %3, i32* nonnull %4, i64 100, i64 100, double* nonnull %9)
  %10 = getelementptr inbounds [10000 x double], [10000 x double]* %8, i64 0, i64 5050
  %11 = load double, double* %10, align 16, !tbaa !8
  %12 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), double %11)
...
49:                                               ; preds = %44, %49
  ...
  br i1 %54, label %35, label %49, !llvm.loop !10
