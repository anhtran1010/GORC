...
define dso_local void @foo() local_unnamed_addr #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %3)
...
17:                                               ; preds = %17, %3
  %18 = phi i32 [ undef, %3 ], [ %19, %17 ]
  %19 = phi i32 [ %16, %3 ], [ %21, %17 ]
...
25:                                               ; preds = %22
  store i32 %18, i32* %2, align 4, !tbaa !4
  br label %26
...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %2 = bitcast i32* %1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %2) #3
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull @2, i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* nonnull %1) #3
  %3 = load i32, i32* %1, align 4, !tbaa !4
  %4 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %3) #3
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %2) #3
  ret i32 0
}
