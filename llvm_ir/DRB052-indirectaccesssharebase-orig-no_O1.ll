...
@.str.2 = private unnamed_addr constant [55 x i8] c"dataracebench/DRB052-indirectaccesssharebase-orig-no.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [23 x i8] c"int main(int, char **)\00", align 1
@str = private unnamed_addr constant [46 x i8] c"Error, malloc() returns NULL. End execution. \00", align 1

; Function Attrs: nounwind uwtable
define dso_local i32 @main(i32 %0, i8** nocapture readnone %1) local_unnamed_addr #0 {
  %3 = alloca double*, align 8
  %4 = alloca double*, align 8
  %5 = call noalias align 16 dereferenceable_or_null(16208) i8* @malloc(i64 16208) #4
  %6 = bitcast i8* %5 to double*
  %7 = icmp eq i8* %5, null
  br i1 %7, label %8, label %10

8:                                                ; preds = %2
  %9 = call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([46 x i8], [46 x i8]* @str, i64 0, i64 0))
  br label %26
...
10:                                               ; preds = %2
  ...
  %15 = getelementptr i8, i8* %5, i64 4168
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(12040) %15, i8 0, i64 12040, i1 false)
...
16:                                               ; preds = %19
  ...
  %18 = icmp eq i64 %17, 2026
  br i1 %18, label %25, label %19, !llvm.loop !8

19:                                               ; preds = %10, %16
  %20 = phi i64 [ 521, %10 ], [ %17, %16 ]
  %21 = getelementptr inbounds double, double* %6, i64 %20
  %22 = load double, double* %21, align 8, !tbaa !11
  %23 = fcmp une double %22, 4.000000e+00
  br i1 %23, label %16, label %24

24:                                               ; preds = %19
  call void @__assert_fail(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.2, i64 0, i64 0), i32 127, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #9
  unreachable
...
define internal void @.omp_outlined.(i32* noalias nocapture readonly %0, i32* noalias nocapture readnone %1, double** nocapture nonnull readonly align 8 dereferenceable(8) %2, double** nocapture nonnull readonly align 8 dereferenceable(8) %3) #3 {
...
24:                                               ; preds = %21, %24
  ...
  store double %31, double* %29, align 8, !tbaa !11
