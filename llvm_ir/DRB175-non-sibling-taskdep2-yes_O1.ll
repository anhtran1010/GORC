; ModuleID = 'dataracebench/DRB175-non-sibling-taskdep2-yes.c'
source_filename = "dataracebench/DRB175-non-sibling-taskdep2-yes.c"
...
define internal void @.omp_outlined.(i32* noalias nocapture readonly %0, i32* noalias nocapture readnone %1, i32* nonnull align 4 dereferenceable(4) %2) #2 {
  ...
  %6 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* nonnull @1, i32 %5, i32 1, i64 40, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*))
  %7 = bitcast i8* %6 to i32***
  %8 = load i32**, i32*** %7, align 8, !tbaa !8
  store i32* %2, i32** %8, align 8, !tbaa.struct !12
  %9 = getelementptr inbounds [1 x %struct.kmp_depend_info], [1 x %struct.kmp_depend_info]* %4, i64 0, i64 0, i32 0
  %10 = ptrtoint i32* %2 to i64
  store i64 %10, i64* %9, align 8, !tbaa !14
  %11 = getelementptr inbounds [1 x %struct.kmp_depend_info], [1 x %struct.kmp_depend_info]* %4, i64 0, i64 0, i32 1
  store i64 4, i64* %11, align 8, !tbaa !17
  %12 = getelementptr inbounds [1 x %struct.kmp_depend_info], [1 x %struct.kmp_depend_info]* %4, i64 0, i64 0, i32 2
  store i8 3, i8* %12, align 8, !tbaa !18
  %13 = bitcast [1 x %struct.kmp_depend_info]* %4 to i8*
  %14 = call i32 @__kmpc_omp_task_with_deps(%struct.ident_t* nonnull @1, i32 %5, i8* %6, i32 1, i8* nonnull %13, i32 0, i8* null)
  ret void
}
...
; Function Attrs: nounwind
declare i32 @__kmpc_omp_task_with_deps(%struct.ident_t*, i32, i8*, i32, i8*, i32, i8*) local_unnamed_addr #4

; Function Attrs: nounwind
declare !callback !24 void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) local_unnamed_addr #4
...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %2) #4
  store i32 0, i32* %1, align 4, !tbaa !4
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull @1, i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* nonnull %1) #4
  %3 = load i32, i32* %1, align 4, !tbaa !4
  %4 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %3) #4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %2) #4
  ret i32 0
}
