...
24:                                               ; preds = %16
  call void @__assert_fail(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.2, i64 0, i64 0), i32 84, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7
  unreachable
...
66:                                               ; preds = %65
  ...
  call void @__kmpc_for_static_fini(%struct.ident_t* @2, i32 %68)
  br label %69

69:                                               ; preds = %66, %28
  %70 = load i32*, i32** %6, align 8
  %71 = load i32, i32* %70, align 4
  call void @__kmpc_barrier(%struct.ident_t* @1, i32 %71)
  %72 = load i32*, i32** %6, align 8
  %73 = load i32, i32* %72, align 4
  call void @__kmpc_critical(%struct.ident_t* @3, i32 %73, [8 x i32]* @.gomp_critical_user_.var)
  %74 = load i32, i32* %22, align 4
  %75 = load i32, i32* @sum0, align 4
  %76 = add nsw i32 %74, %75
  store i32 %76, i32* %22, align 4
  call void @__kmpc_end_critical(%struct.ident_t* @3, i32 %73, [8 x i32]* @.gomp_critical_user_.var)
  ret void
}
