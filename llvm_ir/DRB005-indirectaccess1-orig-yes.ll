...
define internal void @.omp_outlined.(i32* noalias %0, i32* noalias %1, double** nonnull align 8 dereferenceable(8) %2, double** nonnull align 8 dereferenceable(8) %3) #3 {
  ...
  call void @__kmpc_for_static_init_4(%struct.ident_t* @1, i32 %20, i32 33, i32* %14, i32* %11, i32* %12, i32* %13, i32 1, i32 1)
  br label %21

21:                                               ; preds = %69, %4
  %22 = load i32, i32* %12, align 4
  %23 = icmp sgt i32 %22, 179
...
38:                                               ; preds = %34
  ...
  %44 = getelementptr inbounds [180 x i32], [180 x i32]* @indexSet, i64 0, i64 %43
  ...
  %57 = fadd double 3.000000e+00, %56
