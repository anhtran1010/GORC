...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  store i32 2, i32* %1, align 4, !tbaa !4
  %4 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* nonnull @1, i32 %2, i32 1, i64 40, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*))
  %5 = bitcast i8* %4 to i32***
  %6 = load i32**, i32*** %5, align 8, !tbaa !8
  store i32* %1, i32** %6, align 8, !tbaa.struct !12
  %7 = call i32 @__kmpc_omp_task(%struct.ident_t* nonnull @1, i32 %2, i8* %4)
  %8 = call i32 @__kmpc_omp_taskwait(%struct.ident_t* nonnull @1, i32 %2)
...
define internal i32 @.omp_task_entry.(i32 %0, %struct.kmp_task_t_with_privates* noalias nocapture readonly %1) #2 {
  ...
  %7 = load i32, i32* %6, align 4, !tbaa !4, !noalias !14
  %8 = add nsw i32 %7, 1
  store i32 %8, i32* %6, align 4, !tbaa !4, !noalias !14
  ret i32 0
}
...
!13 = !{!11, !11, i64 0}
!14 = !{!15}
!15 = distinct !{!15, !16, !".omp_outlined.: argument 0"}
