...
define internal void @.omp_outlined.(i32* noalias %0, i32* noalias %1, i32* nonnull align 4 dereferenceable(4) %2) #1 {
  ...
  %11 = getelementptr inbounds %struct.anon, %struct.anon* %7, i32 0, i32 0
  store i32* %10, i32** %11, align 8
  %12 = load i32*, i32** %4, align 8
  %13 = load i32, i32* %12, align 4
  %14 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* @1, i32 %13, i32 1, i64 40, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*))
  ...
  %19 = bitcast %struct.anon* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %18, i8* align 8 %19, i64 8, i1 false)
  %20 = getelementptr inbounds [1 x %struct.kmp_depend_info], [1 x %struct.kmp_depend_info]* %8, i64 0, i64 0
  ...
  %27 = call i32 @__kmpc_omp_task_with_deps(%struct.ident_t* @1, i32 %13, i8* %14, i32 1, i8* %26, i32 0, i8* null)
  ret void
}
...
; Function Attrs: nounwind
declare !callback !15 void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) #3
