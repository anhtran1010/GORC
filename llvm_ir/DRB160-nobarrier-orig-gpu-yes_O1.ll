...
define dso_local i32 @main() local_unnamed_addr #0 {
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(64) bitcast ([16 x i32]* @b to i8*), i8 0, i64 64, i1 false)
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 16 dereferenceable(64) bitcast ([16 x i32]* @temp to i8*), i8 0, i64 64, i1 false)
  br label %2

1:                                                ; preds = %2
  store i32 2, i32* @a, align 4, !tbaa !4
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_teams(%struct.ident_t* nonnull @2, i32 4, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, [16 x i32]*, [16 x i32]*, [16 x i32]*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), [16 x i32]* nonnull @temp, [16 x i32]* nonnull @b, [16 x i32]* nonnull @c, i32* nonnull @a) #3
  br label %8

2:                                                ; preds = %0, %2
  %3 = phi i64 [ 0, %0 ], [ %5, %2 ]
  %4 = getelementptr inbounds [16 x i32], [16 x i32]* @c, i64 0, i64 %3
...
8:                                                ; preds = %1, %16
  %9 = phi i64 [ 0, %1 ], [ %17, %16 ]
  %10 = getelementptr inbounds [16 x i32], [16 x i32]* @b, i64 0, i64 %9
...
13:                                               ; preds = %8
  ...
  %15 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0), i32 %14, i32 %11)
  br label %16

16:                                               ; preds = %8, %13
  %17 = add nuw nsw i64 %9, 1
  %18 = icmp eq i64 %17, 16
  br i1 %18, label %7, label %8, !llvm.loop !11
}
...
define internal void @.omp_outlined.(i32* noalias nocapture readonly %0, i32* noalias nocapture readnone %1, [16 x i32]* nocapture nonnull align 4 dereferenceable(64) %2, [16 x i32]* nocapture nonnull align 4 dereferenceable(64) %3, [16 x i32]* nocapture nonnull readonly align 4 dereferenceable(64) %4, i32* nocapture nonnull readonly align 4 dereferenceable(4) %5) #2 {
...
25:                                               ; preds = %6, %66
  ...
  call void @__kmpc_for_static_init_4(%struct.ident_t* nonnull @1, i32 %19, i32 92, i32* nonnull %10, i32* nonnull %7, i32* nonnull %8, i32* nonnull %9, i32 1, i32 1)
...
35:                                               ; preds = %32, %35
  ...
  %39 = getelementptr inbounds [16 x i32], [16 x i32]* %4, i64 0, i64 %36
  %40 = load i32, i32* %39, align 4, !tbaa !4
  %41 = add nsw i32 %40, %38
  %42 = getelementptr inbounds [16 x i32], [16 x i32]* %2, i64 0, i64 %36
...
46:                                               ; preds = %35, %25
  ...
  store i32 15, i32* %12, align 4, !tbaa !4
  ...
  call void @__kmpc_for_static_init_4(%struct.ident_t* nonnull @1, i32 %19, i32 92, i32* nonnull %14, i32* nonnull %11, i32* nonnull %12, i32* nonnull %13, i32 1, i32 1)
...
55:                                               ; preds = %52, %55
  ...
  %62 = getelementptr inbounds [16 x i32], [16 x i32]* %3, i64 0, i64 %57
...
; Function Attrs: nounwind
declare !callback !13 void @__kmpc_fork_teams(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) local_unnamed_addr #3
