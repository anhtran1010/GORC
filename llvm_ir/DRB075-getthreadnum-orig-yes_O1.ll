; ModuleID = 'dataracebench/DRB075-getthreadnum-orig-yes.c'
source_filename = "dataracebench/DRB075-getthreadnum-orig-yes.c"
...
8:                                                ; preds = %3
  ...
  %10 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 %9)
  br label %11
