; ModuleID = 'dataracebench/DRB165-taskdep4-orig-omp50-yes.c'
source_filename = "dataracebench/DRB165-taskdep4-orig-omp50-yes.c"
...
define dso_local void @foo() #0 {
  ...
  %7 = call i32 @__kmpc_global_thread_num(%struct.ident_t* @1)
  store i32 0, i32* %1, align 4
  store i32 2, i32* %2, align 4
  %8 = getelementptr inbounds %struct.anon, %struct.anon* %3, i32 0, i32 0
  store i32* %1, i32** %8, align 8
  %9 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* @1, i32 %7, i32 1, i64 40, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*))
  ...
  %12 = getelementptr inbounds %struct.kmp_task_t, %struct.kmp_task_t* %11, i32 0, i32 0
  %13 = load i8*, i8** %12, align 8
  %14 = bitcast %struct.anon* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %13, i8* align 8 %14, i64 8, i1 false)
  %15 = getelementptr inbounds [1 x %struct.kmp_depend_info], [1 x %struct.kmp_depend_info]* %4, i64 0, i64 0
  %16 = getelementptr %struct.kmp_depend_info, %struct.kmp_depend_info* %15, i64 0
  %17 = getelementptr inbounds %struct.kmp_depend_info, %struct.kmp_depend_info* %16, i32 0, i32 0
  %18 = ptrtoint i32* %1 to i64
  store i64 %18, i64* %17, align 8
  %19 = getelementptr inbounds %struct.kmp_depend_info, %struct.kmp_depend_info* %16, i32 0, i32 1
  store i64 4, i64* %19, align 8
  %20 = getelementptr inbounds %struct.kmp_depend_info, %struct.kmp_depend_info* %16, i32 0, i32 2
  store i8 3, i8* %20, align 8
  store i64 1, i64* %5, align 8
  %21 = bitcast %struct.kmp_depend_info* %15 to i8*
  %22 = call i32 @__kmpc_omp_task_with_deps(%struct.ident_t* @1, i32 %7, i8* %9, i32 1, i8* %21, i32 0, i8* null)
  %23 = getelementptr inbounds %struct.anon.0, %struct.anon.0* %6, i32 0, i32 0
  store i32* %2, i32** %23, align 8
  %24 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* @1, i32 %7, i32 1, i64 40, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates.1*)* @.omp_task_entry..2 to i32 (i32, i8*)*))
  ...
  %29 = bitcast %struct.anon.0* %6 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %28, i8* align 8 %29, i64 8, i1 false)
  %30 = call i32 @__kmpc_omp_task(%struct.ident_t* @1, i32 %7, i8* %24)
  %31 = call i32 @__kmpc_omp_taskwait(%struct.ident_t* @1, i32 %7)
  %32 = load i32, i32* %1, align 4
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %32)
  %34 = load i32, i32* %2, align 4
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32 %34)
  %36 = call i32 @__kmpc_omp_taskwait(%struct.ident_t* @1, i32 %7)
  ret void
}
