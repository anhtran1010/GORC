; ModuleID = 'dataracebench/DRB148-critical1-orig-gpu-yes.c'
source_filename = "dataracebench/DRB148-critical1-orig-gpu-yes.c"
...
22:                                               ; preds = %5, %22
  %23 = phi i32 [ %28, %22 ], [ %20, %5 ]
  call void @__kmpc_critical(%struct.ident_t* nonnull @3, i32 %16, [8 x i32]* nonnull @.gomp_critical_user_addlock.var)
  %24 = load i32, i32* %4, align 4, !tbaa !4
  %25 = add nsw i32 %24, 1
  store i32 %25, i32* %4, align 4, !tbaa !4
  call void @__kmpc_end_critical(%struct.ident_t* nonnull @3, i32 %16, [8 x i32]* nonnull @.gomp_critical_user_addlock.var)
  call void @__kmpc_critical(%struct.ident_t* nonnull @3, i32 %16, [8 x i32]* nonnull @.gomp_critical_user_sublock.var)
  %26 = load i32, i32* %4, align 4, !tbaa !4
  %27 = add nsw i32 %26, -2
  store i32 %27, i32* %4, align 4, !tbaa !4
  call void @__kmpc_end_critical(%struct.ident_t* nonnull @3, i32 %16, [8 x i32]* nonnull @.gomp_critical_user_sublock.var)
  %28 = add nsw i32 %23, 1
