; ModuleID = 'dataracebench/DRB010-lastprivatemissing-var-yes.c'
source_filename = "dataracebench/DRB010-lastprivatemissing-var-yes.c"
...
8:                                                ; preds = %2
  ...
  %11 = call i64 @strtol(i8* nocapture nonnull %10, i8** null, i32 10) #3
...
13:                                               ; preds = %8, %2
  ...
  %15 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %14)
