...
7:                                                ; preds = %2, %7
  %8 = phi i64 [ 0, %2 ], [ %11, %7 ]
  %9 = getelementptr inbounds [1000 x i32], [1000 x i32]* %4, i64 0, i64 %8
...
13:                                               ; preds = %7
  ...
  %14 = getelementptr inbounds [1000 x i32], [1000 x i32]* %4, i64 0, i64 500
  %15 = load i32, i32* %14, align 16, !tbaa !4
  %16 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32 %15)
