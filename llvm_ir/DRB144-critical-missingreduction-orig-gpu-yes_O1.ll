...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %2 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %1)
  ret i32 0
}
...
define internal void @.omp_outlined.(i32* noalias nocapture readonly %0, i32* noalias nocapture readnone %1, i32* nonnull align 4 dereferenceable(4) %2) #1 {
  ...
  store i32 199, i32* %5, align 4, !tbaa !4
  ...
  %15 = select i1 %14, i32 %13, i32 199
...
define internal void @.omp_outlined..1(i32* noalias nocapture readonly %0, i32* noalias nocapture readnone %1, i64 %2, i64 %3, i32* nocapture nonnull align 4 dereferenceable(4) %4) #1 {
  ...
  %11 = bitcast i32* %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %11) #3
  store i32 199, i32* %7, align 4, !tbaa !4
  ...
  %18 = icmp slt i32 %17, 199
  %19 = select i1 %18, i32 %17, i32 199
...
22:                                               ; preds = %5, %22
  ...
  call void @__kmpc_critical(%struct.ident_t* nonnull @3, i32 %16, [8 x i32]* nonnull @.gomp_critical_user_.var)
  %24 = load i32, i32* %4, align 4, !tbaa !4
  %25 = add nsw i32 %24, 1
  store i32 %25, i32* %4, align 4, !tbaa !4
  call void @__kmpc_end_critical(%struct.ident_t* nonnull @3, i32 %16, [8 x i32]* nonnull @.gomp_critical_user_.var)
  %26 = add nsw i32 %23, 1
