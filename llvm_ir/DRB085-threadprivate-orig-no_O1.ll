; ModuleID = 'dataracebench/DRB085-threadprivate-orig-no.c'
source_filename = "dataracebench/DRB085-threadprivate-orig-no.c"
...
@.str.2 = private unnamed_addr constant [45 x i8] c"dataracebench/DRB085-threadprivate-orig-no.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1

; Function Attrs: mustprogress nofree norecurse nosync nounwind uwtable willreturn
define dso_local void @foo(i32 %0) local_unnamed_addr #0 {
  %2 = load i32, i32* @sum0, align 4, !tbaa !4
  %3 = add nsw i32 %2, %0
  store i32 %3, i32* @sum0, align 4, !tbaa !4
  ret void
}
...
26:                                               ; preds = %19
  call void @__assert_fail(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.2, i64 0, i64 0), i32 84, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #9
  unreachable
...
define internal void @.omp_outlined.(i32* noalias nocapture readonly %0, i32* noalias nocapture readnone %1, i32* nocapture nonnull readonly align 4 dereferenceable(4) %2, i32* nocapture nonnull align 4 dereferenceable(4) %3, i32* nonnull readonly align 4 dereferenceable(4) %4) #3 {
...
; Function Attrs: nounwind
declare !callback !8 void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) local_unnamed_addr #5
...
; Function Attrs: nounwind uwtable
define weak_odr hidden i32* @_ZTW4sum0() local_unnamed_addr #8 comdat {
  ret i32* @sum0
}
...
attributes #8 = { nounwind uwtable "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
