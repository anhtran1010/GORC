...
24:                                               ; preds = %12
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @3, i32 5, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, i64, i32*, i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* %4, i64 %9, i32* %11, i32* %7, i32* %3)
...
28:                                               ; preds = %24
  call void @__assert_fail(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.1, i64 0, i64 0), i32 75, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7
  unreachable
...
77:                                               ; preds = %74, %7
  ...
  call void @__kmpc_barrier(%struct.ident_t* @2, i32 %79)
  %80 = load i32*, i32** %8, align 8
  %81 = load i32, i32* %80, align 4
  %82 = call i32 @__kmpc_single(%struct.ident_t* @3, i32 %81)
  %83 = icmp ne i32 %82, 0
  br i1 %83, label %84, label %88

84:                                               ; preds = %77
  %85 = getelementptr inbounds i32, i32* %27, i64 9
  %86 = load i32, i32* %85, align 4
  %87 = add nsw i32 %86, 1
  store i32 %87, i32* %29, align 4
  call void @__kmpc_end_single(%struct.ident_t* @3, i32 %81)
  br label %88

88:                                               ; preds = %84, %77
  %89 = load i32*, i32** %8, align 8
  %90 = load i32, i32* %89, align 4
  call void @__kmpc_barrier(%struct.ident_t* @4, i32 %90)
  ret void
}
