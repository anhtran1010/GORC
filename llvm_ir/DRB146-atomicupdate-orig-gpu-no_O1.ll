...
define dso_local i32 @main() local_unnamed_addr #0 {
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_teams(%struct.ident_t* nonnull @2, i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* nonnull @var) #3
...
18:                                               ; preds = %3, %18
  %19 = phi i32 [ %21, %18 ], [ %16, %3 ]
  %20 = atomicrmw add i32* %2, i32 1 monotonic, align 4
  %21 = add i32 %19, 1
