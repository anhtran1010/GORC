...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_teams(%struct.ident_t* nonnull @3, i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, [64 x i32]*)* @.omp_outlined. to void (i32*, i32*, ...)*), [64 x i32]* nonnull %1) #3
  %3 = getelementptr inbounds [64 x i32], [64 x i32]* %1, i64 0, i64 63
...
18:                                               ; preds = %3, %18
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull @3, i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i64, i64, [64 x i32]*)* @.omp_outlined..1 to void (i32*, i32*, ...)*), i64 %22, i64 %23, [64 x i32]* nonnull %2)
...
; Function Attrs: alwaysinline norecurse nounwind uwtable
define internal void @.omp_outlined..1(i32* noalias nocapture readonly %0, i32* noalias nocapture readnone %1, i64 %2, i64 %3, [64 x i32]* nocapture nonnull align 4 dereferenceable(256) %4) #2 {
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
24:                                               ; preds = %24, %22
  ...
  %26 = getelementptr inbounds [64 x i32], [64 x i32]* %4, i64 0, i64 %25
  %27 = bitcast i32* %26 to <4 x i32>*
  %28 = load <4 x i32>, <4 x i32>* %27, align 4, !tbaa !4, !llvm.access.group !8
  %29 = add nsw <4 x i32> %28, <i32 1, i32 1, i32 1, i32 1>
  %30 = bitcast i32* %26 to <4 x i32>*
  store <4 x i32> %29, <4 x i32>* %30, align 4, !tbaa !4, !llvm.access.group !8
  %31 = add nuw i64 %25, 4
...
; Function Attrs: nounwind
declare !callback !12 void @__kmpc_fork_teams(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) local_unnamed_addr #3
