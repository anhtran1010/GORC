; ModuleID = 'dataracebench/DRB028-privatemissing-orig-yes.c'
source_filename = "dataracebench/DRB028-privatemissing-orig-yes.c"
...
15:                                               ; preds = %9
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull @2, i32 3, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, i32*, [100 x i32]*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* nonnull %4, i32* nonnull %3, [100 x i32]* nonnull %5)
  %16 = getelementptr inbounds [100 x i32], [100 x i32]* %5, i64 0, i64 50
  %17 = load i32, i32* %16, align 8, !tbaa !4
  %18 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 %17)
...
define internal void @.omp_outlined.(i32* noalias nocapture readonly %0, i32* noalias nocapture readnone %1, i32* nocapture nonnull readonly align 4 dereferenceable(4) %2, i32* nocapture nonnull align 4 dereferenceable(4) %3, [100 x i32]* nocapture nonnull align 4 dereferenceable(400) %4) #2 {
...
27:                                               ; preds = %24, %27
  ...
  store i32 %32, i32* %3, align 4, !tbaa !4
