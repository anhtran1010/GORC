...
define dso_local i32 @main() #0 {
  ...
  call void @__omp_offloading_10302_803ef0_main_l27(i32* @var) #3
...
define internal void @__omp_offloading_10302_803ef0_main_l27(i32* nonnull align 4 dereferenceable(4) %0) #1 {
...
37:                                               ; preds = %33
  ...
  call void @__kmpc_critical(%struct.ident_t* @3, i32 %24, [8 x i32]* @.gomp_critical_user_addlock.var)
  %41 = load i32, i32* %18, align 4
  %42 = add nsw i32 %41, 1
  store i32 %42, i32* %18, align 4
  call void @__kmpc_end_critical(%struct.ident_t* @3, i32 %24, [8 x i32]* @.gomp_critical_user_addlock.var)
  call void @__kmpc_critical(%struct.ident_t* @3, i32 %24, [8 x i32]* @.gomp_critical_user_sublock.var)
  %43 = load i32, i32* %18, align 4
  %44 = sub nsw i32 %43, 2
  store i32 %44, i32* %18, align 4
  call void @__kmpc_end_critical(%struct.ident_t* @3, i32 %24, [8 x i32]* @.gomp_critical_user_sublock.var)
  br label %45
