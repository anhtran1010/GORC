...
define internal void @.omp_outlined.(i32* noalias %0, i32* noalias %1, i32* nonnull align 4 dereferenceable(4) %2, i32* nonnull align 4 dereferenceable(4) %3, i32* nonnull align 4 dereferenceable(4) %4, i32* nonnull align 4 dereferenceable(4) %5) #1 {
  ...
  %23 = alloca [1 x %struct.kmp_depend_info], align 8
  %24 = alloca i64, align 8
  %25 = alloca %struct.anon.6, align 8
  %26 = alloca [1 x %struct.kmp_depend_info], align 8
...
39:                                               ; preds = %6
  ...
  %93 = getelementptr inbounds [1 x %struct.kmp_depend_info], [1 x %struct.kmp_depend_info]* %23, i64 0, i64 0
  ...
  %99 = bitcast %struct.kmp_depend_info* %93 to i8*
  %100 = call i32 @__kmpc_omp_task_with_deps(%struct.ident_t* @1, i32 %36, i8* %87, i32 1, i8* %99, i32 0, i8* null)
  %101 = getelementptr inbounds %struct.anon.6, %struct.anon.6* %25, i32 0, i32 0
  store i32* %31, i32** %101, align 8
  %102 = getelementptr inbounds %struct.anon.6, %struct.anon.6* %25, i32 0, i32 1
  store i32* %33, i32** %102, align 8
  %103 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* @1, i32 %36, i32 1, i64 40, i64 16, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates.7*)* @.omp_task_entry..9 to i32 (i32, i8*)*))
  %104 = bitcast i8* %103 to %struct.kmp_task_t_with_privates.7*
  %105 = getelementptr inbounds %struct.kmp_task_t_with_privates.7, %struct.kmp_task_t_with_privates.7* %104, i32 0, i32 0
  %106 = getelementptr inbounds %struct.kmp_task_t, %struct.kmp_task_t* %105, i32 0, i32 0
  %107 = load i8*, i8** %106, align 8
  %108 = bitcast %struct.anon.6* %25 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %107, i8* align 8 %108, i64 16, i1 false)
  %109 = getelementptr inbounds [1 x %struct.kmp_depend_info], [1 x %struct.kmp_depend_info]* %26, i64 0, i64 0
  %110 = getelementptr %struct.kmp_depend_info, %struct.kmp_depend_info* %109, i64 0
  %111 = getelementptr inbounds %struct.kmp_depend_info, %struct.kmp_depend_info* %110, i32 0, i32 0
  %112 = ptrtoint i32* %33 to i64
  store i64 %112, i64* %111, align 8
  %113 = getelementptr inbounds %struct.kmp_depend_info, %struct.kmp_depend_info* %110, i32 0, i32 1
  store i64 4, i64* %113, align 8
  %114 = getelementptr inbounds %struct.kmp_depend_info, %struct.kmp_depend_info* %110, i32 0, i32 2
  store i8 1, i8* %114, align 8
  store i64 1, i64* %27, align 8
  %115 = bitcast %struct.kmp_depend_info* %109 to i8*
  %116 = call i32 @__kmpc_omp_task_with_deps(%struct.ident_t* @1, i32 %36, i8* %103, i32 1, i8* %115, i32 0, i8* null)
  %117 = getelementptr inbounds %struct.anon.8, %struct.anon.8* %28, i32 0, i32 0
  store i32* %34, i32** %117, align 8
  %118 = getelementptr inbounds %struct.anon.8, %struct.anon.8* %28, i32 0, i32 1
  store i32* %31, i32** %118, align 8
  %119 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* @1, i32 %36, i32 1, i64 40, i64 16, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates.9*)* @.omp_task_entry..11 to i32 (i32, i8*)*))
  %120 = bitcast i8* %119 to %struct.kmp_task_t_with_privates.9*
  %121 = getelementptr inbounds %struct.kmp_task_t_with_privates.9, %struct.kmp_task_t_with_privates.9* %120, i32 0, i32 0
  %122 = getelementptr inbounds %struct.kmp_task_t, %struct.kmp_task_t* %121, i32 0, i32 0
  %123 = load i8*, i8** %122, align 8
  %124 = bitcast %struct.anon.8* %28 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %123, i8* align 8 %124, i64 16, i1 false)
  %125 = getelementptr inbounds [1 x %struct.kmp_depend_info], [1 x %struct.kmp_depend_info]* %29, i64 0, i64 0
  %126 = getelementptr %struct.kmp_depend_info, %struct.kmp_depend_info* %125, i64 0
  %127 = getelementptr inbounds %struct.kmp_depend_info, %struct.kmp_depend_info* %126, i32 0, i32 0
  %128 = ptrtoint i32* %31 to i64
  store i64 %128, i64* %127, align 8
  %129 = getelementptr inbounds %struct.kmp_depend_info, %struct.kmp_depend_info* %126, i32 0, i32 1
  store i64 4, i64* %129, align 8
  %130 = getelementptr inbounds %struct.kmp_depend_info, %struct.kmp_depend_info* %126, i32 0, i32 2
  store i8 1, i8* %130, align 8
  store i64 1, i64* %30, align 8
  %131 = bitcast %struct.kmp_depend_info* %125 to i8*
  %132 = call i32 @__kmpc_omp_task_with_deps(%struct.ident_t* @1, i32 %36, i8* %119, i32 1, i8* %131, i32 0, i8* null)
