; ModuleID = 'dataracebench/DRB103-master-orig-no.c'
source_filename = "dataracebench/DRB103-master-orig-no.c"
...
define internal void @.omp_outlined.(i32* noalias %0, i32* noalias %1, i32* nonnull align 4 dereferenceable(4) %2) #1 {
  ...
  %10 = call i32 @__kmpc_master(%struct.ident_t* @1, i32 %9)
  %11 = icmp ne i32 %10, 0
...
12:                                               ; preds = %3
  ...
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i64 0, i64 0), i32 %14)
  call void @__kmpc_end_master(%struct.ident_t* @1, i32 %9)
  br label %16
