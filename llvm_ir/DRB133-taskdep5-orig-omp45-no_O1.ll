; ModuleID = 'dataracebench/DRB133-taskdep5-orig-omp45-no.c'
source_filename = "dataracebench/DRB133-taskdep5-orig-omp45-no.c"
...
define dso_local void @foo() local_unnamed_addr #0 {
  ...
  %40 = call i32 @__kmpc_omp_taskwait(%struct.ident_t* nonnull @1, i32 %6)
  %41 = load i32, i32* %2, align 4, !tbaa !4
  %42 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([6 x i8], [6 x i8]* @.str.5, i64 0, i64 0), i32 %41)
