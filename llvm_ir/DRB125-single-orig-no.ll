; ModuleID = 'dataracebench/DRB125-single-orig-no.c'
source_filename = "dataracebench/DRB125-single-orig-no.c"
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @1, i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* %6)
  ret i32 0
}
...
define internal void @.omp_outlined.(i32* noalias %0, i32* noalias %1, i32* nonnull align 4 dereferenceable(4) %2) #1 {
  ...
  %11 = call i32 @__kmpc_single(%struct.ident_t* @1, i32 %10)
  %12 = icmp ne i32 %11, 0
  br i1 %12, label %13, label %14

13:                                               ; preds = %3
  store i32 10, i32* %8, align 4
  call void @__kmpc_end_single(%struct.ident_t* @1, i32 %10)
  br label %14

14:                                               ; preds = %13, %3
  call void @__kmpc_barrier(%struct.ident_t* @2, i32 %10)
