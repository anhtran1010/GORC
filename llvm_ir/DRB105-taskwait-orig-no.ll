...
@input = dso_local global i32 30, align 4
...
define dso_local i32 @fib(i32 %0) #0 {
  ...
  %8 = call i32 @__kmpc_global_thread_num(%struct.ident_t* @1)
...
13:                                               ; preds = %1
  %14 = getelementptr inbounds %struct.anon, %struct.anon* %6, i32 0, i32 0
  store i32* %4, i32** %14, align 8
  %15 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* @1, i32 %8, i32 1, i64 48, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*))
  %16 = bitcast i8* %15 to %struct.kmp_task_t_with_privates*
  %17 = getelementptr inbounds %struct.kmp_task_t_with_privates, %struct.kmp_task_t_with_privates* %16, i32 0, i32 0
  %18 = getelementptr inbounds %struct.kmp_task_t, %struct.kmp_task_t* %17, i32 0, i32 0
  %19 = load i8*, i8** %18, align 8
  %20 = bitcast %struct.anon* %6 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %19, i8* align 8 %20, i64 8, i1 false)
  %21 = getelementptr inbounds %struct.kmp_task_t_with_privates, %struct.kmp_task_t_with_privates* %16, i32 0, i32 1
  %22 = getelementptr inbounds %struct..kmp_privates.t, %struct..kmp_privates.t* %21, i32 0, i32 0
  %23 = load i32, i32* %3, align 4
  store i32 %23, i32* %22, align 8
  %24 = call i32 @__kmpc_omp_task(%struct.ident_t* @1, i32 %8, i8* %15)
  %25 = getelementptr inbounds %struct.anon.0, %struct.anon.0* %7, i32 0, i32 0
  store i32* %5, i32** %25, align 8
  %26 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* @1, i32 %8, i32 1, i64 48, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates.1*)* @.omp_task_entry..3 to i32 (i32, i8*)*))
  %27 = bitcast i8* %26 to %struct.kmp_task_t_with_privates.1*
  %28 = getelementptr inbounds %struct.kmp_task_t_with_privates.1, %struct.kmp_task_t_with_privates.1* %27, i32 0, i32 0
  %29 = getelementptr inbounds %struct.kmp_task_t, %struct.kmp_task_t* %28, i32 0, i32 0
  %30 = load i8*, i8** %29, align 8
  %31 = bitcast %struct.anon.0* %7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 8 %30, i8* align 8 %31, i64 8, i1 false)
  %32 = getelementptr inbounds %struct.kmp_task_t_with_privates.1, %struct.kmp_task_t_with_privates.1* %27, i32 0, i32 1
  %33 = getelementptr inbounds %struct..kmp_privates.t.2, %struct..kmp_privates.t.2* %32, i32 0, i32 0
  %34 = load i32, i32* %3, align 4
  store i32 %34, i32* %33, align 8
  %35 = call i32 @__kmpc_omp_task(%struct.ident_t* @1, i32 %8, i8* %26)
  %36 = call i32 @__kmpc_omp_taskwait(%struct.ident_t* @1, i32 %8)
...
define dso_local i32 @main() #0 {
  ...
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i32 %3, i32 %4)
...
9:                                                ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.5, i64 0, i64 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.6, i64 0, i64 0), i32 79, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #10
  unreachable
