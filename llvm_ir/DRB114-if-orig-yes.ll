...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %11 = call i32 @__kmpc_global_thread_num(%struct.ident_t* @2)
...
31:                                               ; preds = %24
  call void @__kmpc_serialized_parallel(%struct.ident_t* @2, i32 %11)
  store i32 %11, i32* %9, align 4
  call void @.omp_outlined.(i32* %9, i32* %10, i32* %7, [100 x i32]* %8) #3
  call void @__kmpc_end_serialized_parallel(%struct.ident_t* @2, i32 %11)
  br label %32

32:                                               ; preds = %31, %30
  %33 = getelementptr inbounds [100 x i32], [100 x i32]* %8, i64 0, i64 50
  %34 = load i32, i32* %33, align 8
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 %34)
  ret i32 0
}
...
define internal void @.omp_outlined.(i32* noalias %0, i32* noalias %1, i32* nonnull align 4 dereferenceable(4) %2, [100 x i32]* nonnull align 4 dereferenceable(400) %3) #2 {
...
; Function Attrs: nounwind
declare void @__kmpc_serialized_parallel(%struct.ident_t*, i32) #3

; Function Attrs: nounwind
declare void @__kmpc_end_serialized_parallel(%struct.ident_t*, i32) #3
