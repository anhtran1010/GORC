; ModuleID = 'dataracebench/DRB001-antidep1-orig-yes.c'
source_filename = "dataracebench/DRB001-antidep1-orig-yes.c"
...
21:                                               ; preds = %9
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* @2, i32 2, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, [1000 x i32]*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* %7, [1000 x i32]* %8)
  %22 = getelementptr inbounds [1000 x i32], [1000 x i32]* %8, i64 0, i64 500
  %23 = load i32, i32* %22, align 16
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32 %23)
  ret i32 0
}
