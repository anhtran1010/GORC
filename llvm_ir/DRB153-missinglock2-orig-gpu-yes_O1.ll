; ModuleID = 'dataracebench/DRB153-missinglock2-orig-gpu-yes.c'
source_filename = "dataracebench/DRB153-missinglock2-orig-gpu-yes.c"
...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @__kmpc_push_num_teams(%struct.ident_t* nonnull @3, i32 %3, i32 1, i32 0) #3
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_teams(%struct.ident_t* nonnull @3, i32 1, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* nonnull %1) #3
  %4 = load i32, i32* %1, align 4, !tbaa !4
  %5 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %4)
...
; Function Attrs: alwaysinline norecurse nounwind uwtable
define internal void @.omp_outlined..1(i32* noalias nocapture readonly %0, i32* noalias nocapture readnone %1, i64 %2, i64 %3, i32* nocapture nonnull align 4 dereferenceable(4) %4) #2 {
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
...
22:                                               ; preds = %5
  ...
  %25 = add i32 %24, 1
  %26 = sub i32 %25, %20
  store i32 %26, i32* %4, align 4, !tbaa !4
  br label %27
