...
15:                                               ; preds = %5
  call void @__omp_offloading_10302_803f27_main_l25([100 x i32]* %2) #2
...
26:                                               ; preds = %19
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0))
  store i32 0, i32* %1, align 4
  br label %33
...
define internal void @__omp_offloading_10302_803f27_main_l25([100 x i32]* nonnull align 4 dereferenceable(400) %0) #1 {
...
; Function Attrs: nounwind
declare !callback !8 void @__kmpc_fork_teams(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) #2
