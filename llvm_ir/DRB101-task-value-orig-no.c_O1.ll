...
define dso_local void @_Z8gen_taski(i32 %0) local_unnamed_addr #0 {
  ...
  store i32 %0, i32* %5, align 8, !tbaa !4
  %6 = call i32 @__kmpc_omp_task(%struct.ident_t* nonnull @1, i32 %2, i8* %3)
  ret void
}
...
define internal i32 @.omp_task_entry.(i32 %0, %struct.kmp_task_t_with_privates* noalias nocapture readonly %1) #1 {
  ...
  %4 = load i32, i32* %3, align 4, !tbaa !15, !alias.scope !12
  %5 = add nsw i32 %4, 1
  %6 = sext i32 %4 to i64
  %7 = getelementptr inbounds [100 x i32], [100 x i32]* @a, i64 0, i64 %6
  store i32 %5, i32* %7, align 4, !tbaa !15, !noalias !12
  ret i32 0
}
...
8:                                                ; preds = %7, %8
  %9 = phi i32 [ 0, %7 ], [ %16, %8 ]
  %10 = call i32 @__kmpc_global_thread_num(%struct.ident_t* nonnull @1) #2
  %11 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* nonnull @1, i32 %10, i32 1, i64 48, i64 1, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates*)* @.omp_task_entry. to i32 (i32, i8*)*)) #2
  %12 = getelementptr inbounds i8, i8* %11, i64 40
  %13 = bitcast i8* %12 to i32*
  store i32 %9, i32* %13, align 8, !tbaa !4
  %14 = call i32 @__kmpc_omp_task(%struct.ident_t* nonnull @1, i32 %10, i8* %11) #2
...
!4 = !{!5, !10, i64 40}
!5 = !{!"_ZTS24kmp_task_t_with_privates", !6, i64 0, !11, i64 40}
!6 = !{!"_ZTS10kmp_task_t", !7, i64 0, !7, i64 8, !10, i64 16, !8, i64 24, !8, i64 32}
!7 = !{!"any pointer", !8, i64 0}
!8 = !{!"omnipotent char", !9, i64 0}
!9 = !{!"Simple C++ TBAA"}
!10 = !{!"int", !8, i64 0}
!11 = !{!"_ZTS15.kmp_privates.t", !10, i64 0}
!12 = !{!13}
!13 = distinct !{!13, !14, !".omp_outlined.: argument 0"}
