; ModuleID = 'dataracebench/DRB047-doallchar-orig-no.c'
source_filename = "dataracebench/DRB047-doallchar-orig-no.c"
...
; Function Attrs: nounwind
declare !callback !9 void @__kmpc_fork_call(%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) local_unnamed_addr #3
