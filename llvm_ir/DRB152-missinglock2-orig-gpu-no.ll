...
define dso_local i32 @main() #0 {
  ...
  call void @__omp_offloading_10302_803ee5_main_l23(%struct.omp_lock_t* %2, i32* %3) #3
...
define internal void @__omp_offloading_10302_803ee5_main_l23(%struct.omp_lock_t* nonnull align 8 dereferenceable(8) %0, i32* nonnull align 4 dereferenceable(4) %1) #2 {
  %3 = alloca %struct.omp_lock_t*, align 8
  %4 = alloca i32*, align 8
  %5 = call i32 @__kmpc_global_thread_num(%struct.ident_t* @3)
  store %struct.omp_lock_t* %0, %struct.omp_lock_t** %3, align 8
  store i32* %1, i32** %4, align 8
  %6 = load %struct.omp_lock_t*, %struct.omp_lock_t** %3, align 8
  %7 = load i32*, i32** %4, align 8
  call void @__kmpc_push_num_teams(%struct.ident_t* @3, i32 %5, i32 1, i32 0)
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_teams(%struct.ident_t* @3, i32 2, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, %struct.omp_lock_t*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), %struct.omp_lock_t* %6, i32* %7)
  ret void
}
