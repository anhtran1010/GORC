...
define dso_local i32 @main() #0 {
  ...
  call void @__kmpc_push_num_threads(%struct.ident_t* @2, i32 %4, i32 10)
...
8:                                                ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1, i64 0, i64 0), i32 70, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7
  unreachable
...
define internal void @.omp_outlined.(i32* noalias %0, i32* noalias %1, i32* nonnull align 4 dereferenceable(4) %2) #1 {
  ...
  %18 = bitcast [1 x i8*]* %9 to i8*
  %19 = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @1, i32 %17, i32 1, i64 8, i8* %18, void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
20:                                               ; preds = %3
  ...
  call void @__kmpc_end_reduce_nowait(%struct.ident_t* @1, i32 %17, [8 x i32]* @.gomp_critical_user_.reduction.var)
  br label %27

24:                                               ; preds = %3
  %25 = load i32, i32* %8, align 4
  %26 = atomicrmw add i32* %10, i32 %25 monotonic, align 4
  br label %27
