; ModuleID = 'dataracebench/DRB036-truedepscalar-var-yes.c'
source_filename = "dataracebench/DRB036-truedepscalar-var-yes.c"
...
13:                                               ; preds = %8, %2
  ...
  call void (%struct.ident_t*, i32, void (i32*, i32*, ...)*, ...) @__kmpc_fork_call(%struct.ident_t* nonnull @2, i32 4, void (i32*, i32*, ...)* bitcast (void (i32*, i32*, i32*, i64, i32*, i32*)* @.omp_outlined. to void (i32*, i32*, ...)*), i32* nonnull %4, i64 %15, i32* nonnull %17, i32* nonnull %3)
...
28:                                               ; preds = %25, %28
  ...
  store i32 %33, i32* %5, align 4, !tbaa !4
  %34 = add nsw i64 %29, 1
