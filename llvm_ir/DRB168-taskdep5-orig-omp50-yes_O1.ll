; ModuleID = 'dataracebench/DRB168-taskdep5-orig-omp50-yes.c'
source_filename = "dataracebench/DRB168-taskdep5-orig-omp50-yes.c"
...
define dso_local void @foo() local_unnamed_addr #0 {
  ...
  %36 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32 %35)
  %37 = call i32 @__kmpc_omp_taskwait(%struct.ident_t* nonnull @1, i32 %5)
