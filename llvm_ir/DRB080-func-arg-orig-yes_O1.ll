...
define dso_local void @f1(i32* nocapture %0) local_unnamed_addr #0 {
  ...
  %3 = add nsw i32 %2, 1
  store i32 %3, i32* %0, align 4, !tbaa !4
  ret void
}
...
define internal void @.omp_outlined.(i32* noalias nocapture readnone %0, i32* noalias nocapture readnone %1, i32* nocapture nonnull align 4 dereferenceable(4) %2) #3 {
