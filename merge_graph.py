...
bug_graphs_file = "indigo_bug_trans_noarith_hetero.bin"
bug_labels_file = "indigo_bug_trans_noarith_hetero_labels"
nobug_graphs_file = "indigo_nobug_trans_noarith_hetero.bin"
nobug_labels_file = "indigo_nobug_trans_noarith_hetero_labels"
...
all_labels_file = open("indigo_trans_noarith_hetero_labels", "wb")
pickle.dump(all_labels, all_labels_file)

dgl.save_graphs("indigo_trans_noarith_hetero_graphs.bin", all_graphs)